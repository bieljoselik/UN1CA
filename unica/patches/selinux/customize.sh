...
ADD_TO_WORK_DIR "m2sxxx" "system_ext" "etc/selinux/mapping" 0 0 755 "u:object_r:system_lib_file:s0"
ADD_TO_WORK_DIR "m2sxxx" "product" "etc/selinux/mapping" 0 0 755 "u:object_r:system_lib_file:s0"
