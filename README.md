...
MonsterROM-REBORN is a work-in-progress custom firmware for Samsung Galaxy devices, designed to provide a refined, optimized and more rich One UI experience.
...
The MonsterROM-REBORN build system automatically builds the required tools, downloads and extracts firmware components, applies the required patches and generates a flashable zip for the target device.
...
### MonsterROM-REBORN-exclusive features:
